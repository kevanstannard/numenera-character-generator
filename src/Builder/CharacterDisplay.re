...
let make = (~character: CharacterBuilder.character) => {
  ...
  let content =
    ...
    ++ line("")
    ++ line("MIGHT")
    ++ line(mightDisplay.total)
    ++ line("")
    ++ lines(mightDisplay.reasons)
    ++ line("")
    ++ line("MIGHT EDGE")
    ++ line(mightEdgeDisplay.total)
    ++ line("")
    ++ line("SPEED")
    ++ line(speedDisplay.total)
    ++ line("")
    ++ lines(speedDisplay.reasons)
    ++ line("")
    ++ line("SPEED EDGE")
    ++ line(speedEdgeDisplay.total)
    ++ line("")
    ++ line("INTELLECT")
    ++ line(intellectDisplay.total)
    ++ line("")
    ++ lines(intellectDisplay.reasons)
    ++ line("")
    ++ line("INTELLECT EDGE")
    ++ line(intellectEdgeDisplay.total)
    ++ line("");
